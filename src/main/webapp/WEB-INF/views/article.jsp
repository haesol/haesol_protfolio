                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <ul class="list-unstyled">
                                <li><a id="all-category" href="#">모든 아티클</a></li>
                                <li><a id="devstory-category" href="#">개발자 이야기</a></li>
                                <li><a id="etc-category" href="#">기타</a></li>
                            </ul>
                        </div>
                        <!-- /.col-lg-6 -->
                        <div class="col-lg-6">
                            <ul class="list-unstyled">
                                ...
                                <li><a id="tipntech-category" href="#">팁&테크</a></li>
                            </ul>
                        </div>
                        <!-- /.col-lg-6 -->
                    </div>
